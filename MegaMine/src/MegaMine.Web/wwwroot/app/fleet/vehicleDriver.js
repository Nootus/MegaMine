...
vehicleDriver.$inject = ['$scope', '$window', 'vehicleService', "MegaMine.Shared.GridUtility", "MegaMine.Shared.Utility", "MegaMine.Shared.Constants", "MegaMine.Shared.DialogService", "MegaMine.Shared.Template", "MegaMine.Shared.Message"];
