...
vehicleList.$inject = ['$scope', 'vehicleService', 'vehicleDialog', "MegaMine.Shared.GridUtility", "MegaMine.Shared.Navigation", "MegaMine.Shared.Constants", "MegaMine.Shared.Template"];
