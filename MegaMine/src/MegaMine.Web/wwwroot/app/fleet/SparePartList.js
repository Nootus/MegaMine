...
sparePartList.$inject = ['$scope', 'vehicleService', 'sparePartDialog', "MegaMine.Shared.GridUtility", "MegaMine.Shared.Navigation", "MegaMine.Shared.Constants", "MegaMine.Shared.Template"];
