...
manufacturerList.$inject = ['$scope', 'vehicleService', 'manufacturerDialog', "MegaMine.Shared.GridUtility", "MegaMine.Shared.Navigation", "MegaMine.Shared.Constants", "MegaMine.Shared.Template"];
