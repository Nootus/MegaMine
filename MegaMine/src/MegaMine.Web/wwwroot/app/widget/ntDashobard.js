...
ntDashobard.$inject = ['$timeout', '$state', '$stateParams', 'chart', "MegaMine.Shared.Dialog.DialogService", "MegaMine.Shared.Utility", "MegaMine.Shared.Template", "MegaMine.Shared.Constants"];
