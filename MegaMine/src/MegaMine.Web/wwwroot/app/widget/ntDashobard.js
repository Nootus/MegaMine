...
ntDashobard.$inject = ['$timeout', '$state', '$stateParams', 'chart', "MegaMine.Shared.DialogService", "MegaMine.Shared.Utility", "MegaMine.Shared.Template", "MegaMine.Shared.Constants"];
