...
ntDashobard.$inject = ['$timeout', '$state', '$stateParams', "MegaMine.Widget.ChartOptions", "MegaMine.Shared.Dialog.DialogService", "MegaMine.Shared.Utility", "MegaMine.Shared.Template", "MegaMine.Shared.Constants"];
