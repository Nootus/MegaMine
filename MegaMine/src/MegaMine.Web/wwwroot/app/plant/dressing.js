...
dressing.$inject = ['$scope', 'uiGridConstants', 'uiGridValidateService', 'moment', 'plantService', "MegaMine.Shared.DialogUtility", "MegaMine.Shared.Utility", "MegaMine.Shared.Message"];
