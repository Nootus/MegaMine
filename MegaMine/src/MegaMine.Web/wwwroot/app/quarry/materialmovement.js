...
materialMovement.$inject = ['$scope', "MegaMine.Quarry.QuarryService", "MegaMine.Shared.GridUtility", "MegaMine.Shared.Dialog.DialogUtility", "MegaMine.Shared.Constants", "MegaMine.Shared.Message"];
