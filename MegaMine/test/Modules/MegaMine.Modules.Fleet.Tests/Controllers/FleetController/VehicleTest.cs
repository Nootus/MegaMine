...
namespace MegaMine.Modules.Fleet.Tests.Controllers.FleetController
{
    ...
    public class VehicleTest : FleetControllerTest
    {
        ...
        [InlineData(true)]
        [InlineData(false)]
        public async void VehicleServiceAdd(bool updateServiceRecord)
        {
            // Arrange
            this.FleetDbContext.VehicleTypes.AddRange(
                    new VehicleTypeEntity() { VehicleTypeId = 1, VehicleTypeName = "Escavator", CompanyId = 1, DeletedInd = false },
            ...
            {
                this.FleetDbContext.VehicleServices.AddRange(
                        new VehicleServiceEntity() { VehicleServiceId = 1, VehicleId = 1, ServiceStartDate = new DateTime(2016, 1, 1), TotalServiceCost = 100.50M, CompanyId = 1, DeletedInd = false },
                        new VehicleServiceEntity() { VehicleServiceId = 2, VehicleId = 2, ServiceStartDate = new DateTime(2016, 6, 1), TotalServiceCost = 100.52M, CompanyId = 1, DeletedInd = false },
                        new VehicleServiceEntity() { VehicleServiceId = 3, VehicleId = 1, ServiceStartDate = new DateTime(2016, 6, 1), TotalServiceCost = 200M, CompanyId = 1, DeletedInd = false });
            }
            else
            {
                this.FleetDbContext.VehicleServices.AddRange(
                        ...
                        new VehicleServiceEntity() { VehicleServiceId = 0, VehicleId = 2, ServiceStartDate = new DateTime(2016, 6, 1), TotalServiceCost = 100.52M, CompanyId = 1, DeletedInd = false },
            ...
            if (updateServiceRecord)
            {
                model = new VehicleServiceModel() { VehicleServiceId = 1, VehicleId = 1, MiscServiceCost = 200, ServiceDate = new DateTime(2016, 10, 1) };
            }
            else
            {
                model = new VehicleServiceModel() { VehicleServiceId = 0, VehicleId = 1, MiscServiceCost = 200, ServiceDate = new DateTime(2016, 10, 1) };
            }
