    ...
    public class VehicleTest : FleetControllerTest
    {
        ...
        public async void VehicleList()
        {
            ...
            this.FleetDbContext.Vehicles.AddRange(
                    new VehicleEntity() { VehicleId = 1, RegistrationNumber = "AP12DB1234", LastServiceDate = new DateTime(2016, 1, 1), TotalServiceCost = 1000, FuelAverage = 10.25M, CompanyId = 1, DeletedInd = false, VehicleTypeId = 1, VehicleModelId = 1, VehicleDriverId = 1 },
                    ...
                    new VehicleEntity() { VehicleId = 3, RegistrationNumber = "AP12DB7890", LastServiceDate = new DateTime(2016, 6, 15), TotalServiceCost = 2500, FuelAverage = 15.25M, CompanyId = 1, DeletedInd = false, VehicleTypeId = 2, VehicleModelId = 2, VehicleDriverId = 2 });
